...
MODEL_SET : ModelSet =\
{
	'open_nsfw':
	{
		'hashes':
		{
			'content_analyser':
			{
				'url': 'https://github.moeyy.xyz/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/open_nsfw.hash',
		...
		'sources':
		{
			'content_analyser':
			{
				'url': 'https://github.moeyy.xyz/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/open_nsfw.onnx',
