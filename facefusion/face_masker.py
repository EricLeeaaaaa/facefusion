...
MODEL_SET : ModelSet =\
{
	'face_occluder':
	{
		'hashes':
		{
			'face_occluder':
			{
				'url': 'https://github.moeyy.xyz/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/dfl_xseg.hash',
		...
		'sources':
		{
			'face_occluder':
			{
				'url': 'https://github.moeyy.xyz/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/dfl_xseg.onnx',
	...
	'face_parser':
	{
		'hashes':
		{
			'face_parser':
			{
				'url': 'https://github.moeyy.xyz/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/bisenet_resnet_34.hash',
		...
		'sources':
		{
			'face_parser':
			{
				'url': 'https://github.moeyy.xyz/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/bisenet_resnet_34.onnx',
